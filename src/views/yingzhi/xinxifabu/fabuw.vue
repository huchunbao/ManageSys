  ...
  <div class="fabuw">
    ...
    <div class="right">
      ...
      <div class="right_body">
        <div class="chuang">
          当前窗口: <input v-model="dataname" type="text" disabled>
        </div>
        <div>
          <div class="wdata">窗口位置:</div>
          <div class="wdatali">
            Y <input v-model="left" type="text" disabled>
          </div>
          <div class="wdatali">
            X <input v-model="top" type="text" disabled>
          </div>
          <div class="wdatali">
            H <input v-model="height" type="text" disabled>
          </div>
          <div class="wdatali">
            W <input v-model="width" type="text" disabled>
          </div>
        </div>
        <div class="kongzhi">
...
.kongzhi .kongzhi_jian {
  width: 30px;
  height: 30px;
  background: url("../../assets/jian.png") no-repeat;
  overflow: hidden;
}
.kongzhi .kongzhi_shang {
  width: 30px;
