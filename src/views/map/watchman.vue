<template>
  <div class="routeinstall">
    <div class="scroll_box" tag="ul">
      ...
      <el-button v-if="!divtab" type="primary" style="margin-left:20%;width:60%;margin-top:5%;" round @click="divtab=!divtab">新建路线</el-button>
      <!-- 第二页面 -->
      <div v-if="divtab" id="scroll" class="leftdiv">
        <div class="leftdiv_list title_name">巡更线路</div>
        <div class="leftdiv_list">
          路线类型<div class="star">*</div><div class="names_type">巡更线路</div>
        </div>
        <div class="leftdiv_list">
          <div class="star">*</div>
          路线名称
...
export default {
  ...
  methods: {
    ...
    shebei() {
      get('/camara/getEqType?', { cpid: this.$store.state.user.companyId, system_id: 5 }).then(res => {
        console.log(res)
        this.options2 = res
      })
    },
    ...
    bian(obj) {
      ...
      console.log(this.value2, obj.row.label.equimentId * 1)
      this.data = []
